...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="view ml-0" style="background-image: 
        url('https://www.kindpng.com/picc/m/616-6165442_label-hd-png-download.png'); 
        background-repeat: no-repeat; background-attachment:fixed; background-position: left">
