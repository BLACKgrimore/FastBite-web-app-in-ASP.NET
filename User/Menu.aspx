...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="view ml-0" style="background-image: 
        url('https://www.kindpng.com/picc/m/6-62783_transparent-pizzaiolo-png-cook-png-png-download.png'); 
                ...
                <asp:Repeater ID="rCategory" runat="server">
                    <ItemTemplate>
                        <li data-filter=".<%# Regex.Replace(Eval("Name").ToString().ToLower(),@"\s+","") %>"
                            data-id="<%# Eval("CategoriesId") %>"><%# Eval("Name") %></li>
                    </ItemTemplate>
                </asp:Repeater>
            </ul>
                                        ...
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                ...
                                                <asp:LinkButton runat="server" ID="lbAddToCart" CommandName="addToCart"
                                                    CommandArgument='<%# Eval("ProductsId") %>'>                                                       
