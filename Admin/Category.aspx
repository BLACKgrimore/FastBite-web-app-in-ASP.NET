<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" 
    CodeBehind="Category.aspx.cs" Inherits="Foodie.Admin.Category" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" cssclass="badge badge-primary"
                                                                       CommandArgument='<%# Eval("CategoriesId") %>' runat="server" 
                                                                        CommandName="edit">
                                                                        <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" cssclass="badge badge-danger"
                                                                       CommandArgument='<%# Eval("CategoriesId") %>' runat="server" 
                                                                        CommandName="delete" OnClientClick="return confirm('Do you want to delete this category?');">
                                                                        <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
