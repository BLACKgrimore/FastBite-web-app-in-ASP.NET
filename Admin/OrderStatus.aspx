<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" 
    Inherits="Foodie.Admin.OrderStatus" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkEdit" Text="Edit" CssClass="badge badge-primary"
                                                                        CommandArgument='<%# Eval("OrderDetailsId") %>' runat="server"
                                                                        CommandName="edit">
                                                                        <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
                                                                </td>
                                                ...
                                                <div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvDdlOrderStatus" runat="server" ForeColor="Red" 
                                                                ControlToValidate="ddlOrderStatus" ErrorMessage="Order status is required" 
                                                    ...
                                                    <div class="pb-5">
                                                     ...
                                                     <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-primary"
                                                         CauseValidation="false" OnClick="btnCancel_Click" />
                                                    </div>
                                                </div>
                                            </asp:Panel>
                                        </div>
